 ...
 *  com.yandex.mobile.ads.impl.jg0
...
implements jg0 {
    @NotNull
    public final ig0 a(@NotNull aj object, @NotNull gu1.b b11, @NotNull gf2 gf22, @NotNull ck0 ck02) {
        object = new vj((zf1)((Object)object));
        ((vj)object).a(b11);
        return object;
    }

    @NotNull
    public final ig0 a(@NotNull x21 object, @NotNull og0 og02, @NotNull bf2 bf22, @NotNull o21 o212, @NotNull o21 o213, @NotNull o21 o214) {
        object = new vj((zf1)((Object)object));
        ((vj)object).a(og02);
        return object;
    }
    ...
    @NotNull
    public final zc0 a(@NotNull id0 object, @NotNull ad0 ad02, @NotNull ed0 ed02, @NotNull qc0 qc02, @NotNull ed0 ed03) {
        object = new uj((id0)((Object)object));
        ((vj)object).a(ad02);
        return object;
    }
}
