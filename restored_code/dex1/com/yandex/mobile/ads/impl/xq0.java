...
implements xd0 {
    ...
    public xq0(@NotNull tp tp3, @NotNull wp1 wp12, @NotNull xq1 xq12, @NotNull jq jq3) {
        this.a = tp3;
        this.b = wp12;
        this.c = xq12;
        this.d = jq3;
    ...
    public final ar0 a(@NotNull Context object, @NotNull b8 object2, @NotNull t61 t612, @NotNull nr nr2, @NotNull ht ht3) {
        ...
        int n10 = R.dimen.monetization_ads_internal_landscape_vertical_icon_size;
        object3.getClass();
        qq qq3 = new qq((gt)object2, kotlin.math.a.d((float)object.getResources().getDimension(n10)));
        jq jq3 = this.d;
        t00<ExtendedNativeAdView> t002 = this.a;
        object3 = this.b;
        jq3.getClass();
        object2 = new oq(qq3, jq.a((t61)t612, (nr)nr2, (ht)ht3, t002, (wp1)object3), new tu0((gt)object2), new nh1((gt)object2), new uj2(), new dn(t612));
        nr2 = t612.getAdAssets();
        t612 = this.c;
        n10 = R.dimen.monetization_ads_internal_landscape_vertical_media_content_min_width;
        t612.getClass();
        n10 = kotlin.math.a.d((float)object.getResources().getDimension(n10));
        object = new pq(new mf1(2), new av0(n10, new uu0((gt)nr2)));
        return new ar0(R.layout.monetization_ads_internal_native_interstitial_landscape_vetrical_media, (oq)object2, (u00)object);
    }
}
