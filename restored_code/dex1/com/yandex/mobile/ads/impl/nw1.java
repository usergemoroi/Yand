...
implements vc0<es1> {
    ...
    public nw1(@NotNull cd0<es1> p42, @NotNull gv1 gv12, @NotNull g61 g612) {
        x2 x22;
        this.a = p42;
        this.b = g612;
        g612 = p42.k();
    ...
    public final Object a(sd0 object, Activity activity) {
        es1 es12 = (es1)object;
        object = u.d;
        Object object2 = u.b(v.a((Throwable)a6.a()));
        ...
        if (b82 != null) {
            object = object2;
            if (t612 != null) {
                object = new y0(new y0.a(b82, this.e, es12.i()).a(this.e.n()).a(t612));
                object = this.g.a((Context)activity, (y0)object);
                this.h = null;
                this.i = null;
            }
        }
    ...
    implements gr1 {
        ...
        public a(nw1 nw12, @NotNull Context context, @NotNull b8<String> b82) {
            this.c = nw12;
            this.a = b82;
