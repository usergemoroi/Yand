...
n {
    ...
    public void onBillingConfigChanged(@Nullable BillingConfig billingConfig) {
        synchronized (this) {
            ...
            if (billingConfig != null && !this.h) {
                ...
                Object object = new l();
                BillingClient billingClient = builder.setListener((PurchasesUpdatedListener)object).enablePendingPurchases().build();
                BillingLibraryMonitor$updateBilling$1 billingLibraryMonitor$updateBilling$1 = new BillingLibraryMonitor$updateBilling$1(this);
                object = new d(billingClient);
                b b11 = new b(billingConfig, billingClient, billingLibraryMonitor$updateBilling$1, (d)object, this);
    ...
    public void onSessionResumed() {
        ...
        if (!this.h) {
            ...
            BillingClient.Builder builder = BillingClient.newBuilder((Context)this.a);
            Object object = new l();
            builder = builder.setListener((PurchasesUpdatedListener)object).enablePendingPurchases().build();
            BillingLibraryMonitor$updateBilling$1 billingLibraryMonitor$updateBilling$1 = new BillingLibraryMonitor$updateBilling$1(this);
            d d14 = new d((BillingClient)builder);
            object = new b(billingConfig, (BillingClient)builder, billingLibraryMonitor$updateBilling$1, d14, this);
            builder.startConnection((BillingClientStateListener)object);
        }
    }
