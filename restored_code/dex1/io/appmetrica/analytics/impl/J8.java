...
extends MessageNano {
    ...
    public static J8 a(byte[] byArray) throws InvalidProtocolBufferNanoException {
        return MessageNano.mergeFrom(new J8(), byArray);
    }

    public static J8 b(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        return new J8().a(codedInputByteBufferNano);
    }
    ...
    public final J8 a(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        int n10;
