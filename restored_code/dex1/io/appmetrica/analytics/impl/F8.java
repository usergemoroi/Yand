...
extends MessageNano {
    ...
    public static F8 a(byte[] byArray) throws InvalidProtocolBufferNanoException {
        return MessageNano.mergeFrom(new F8(), byArray);
    }

    public static F8 b(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        return new F8().a(codedInputByteBufferNano);
    }
    ...
    public final F8 a(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        int n10;
