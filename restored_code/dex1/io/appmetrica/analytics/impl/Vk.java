...
extends MessageNano {
    ...
    public static Vk a(byte[] byArray) throws InvalidProtocolBufferNanoException {
        return MessageNano.mergeFrom(new Vk(), byArray);
    }

    public static Vk b(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        return new Vk().a(codedInputByteBufferNano);
    }
    ...
    public final Vk a(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        int n10;
