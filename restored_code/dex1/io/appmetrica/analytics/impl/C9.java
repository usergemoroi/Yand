...
extends MessageNano {
    ...
    public static C9 a(byte[] byArray) throws InvalidProtocolBufferNanoException {
        return MessageNano.mergeFrom(new C9(), byArray);
    }

    public static C9 b(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        return new C9().a(codedInputByteBufferNano);
    }
    ...
    public final C9 a(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        int n10;
