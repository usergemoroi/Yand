...
extends h {
    ...
    static {
        ...
        boolean bl = false;
        try {
            Class.forName("org.bouncycastle.jsse.provider.BouncyCastleJsseProvider", false, a4.getClass().getClassLoader());
            bl = true;
        }
    ...
    public void e(@NotNull SSLSocket sSLSocket, @Nullable String string, @NotNull List<a0> list) {
        ...
        if (sSLSocket instanceof BCSSLSocket) {
            ...
            string.setApplicationProtocols(((Collection)h.a.b(list)).toArray(new String[0]));
        ...
        block4: {
            block2: {
                block3: {
                    ...
                    if (!(object instanceof BCSSLSocket)) break block2;
            ...
            object = super.h((SSLSocket)object);
        }
        return object;
    }
    ...
    public X509TrustManager p() {
        Object object;
        Object object2 = TrustManagerFactory.getInstance("PKIX", "BCJSSE");
