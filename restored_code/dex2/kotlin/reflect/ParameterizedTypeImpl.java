...
TypeImpl {
    ...
    public ParameterizedTypeImpl(@NotNull Class<?> clazz, @Nullable Type type, @NotNull List<? extends Type> list) {
        y.j(clazz, (String)"rawType");
        y.j(list, (String)"typeArguments");
        this.rawType = clazz;
        this.ownerType = type;
        this.typeArguments = ((Collection)list).toArray(new Type[0]);
    }

    public boolean equals(@Nullable Object object) {
        Class<?> clazz;
        boolean bl = object instanceof ParameterizedType && y.e(clazz = this.rawType, (Object)(object = (ParameterizedType)object).getRawType()) && y.e((Object)this.ownerType, (Object)object.getOwnerType()) && Arrays.equals(this.getActualTypeArguments(), object.getActualTypeArguments());
        return bl;
    }
    ...
    public String getTypeName() {
        ...
        if (bl ^ true) {
            l.B0(objectArray, charSequence, null, "<", ">", 0, null, getTypeName.1.1.INSTANCE, 50, null);
        }
    ...
    public int hashCode() {
        ...
        int n5 = type != null ? type.hashCode() : 0;
        return n4 ^ n5 ^ Arrays.hashCode(this.getActualTypeArguments());
    }
